...
pub fn setup(mut commands: Commands) {
    ...
    spawn_zone(&mut commands, (100.0, 100.0), (300.0, 50.0), are_boxes_visible, &mut zone_id);
}
...
pub fn check_zone(query: Query<&Transform, With<crate::player::Player>>, mut izone_query: Query<((&Transform, &mut Sprite, &IZone), With<IZone>), Without<crate::player::Player>>) {
